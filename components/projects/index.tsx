                            ...
                            return(
                                <div key={index} className="flex flex-col md:flex-row w-full mb-3">
                                    ...
                                    <div className="flex flex-col pb-2 justify-center items-center md:w-2/4 md:py-4 px-6">
                                        <h3 className="t-project text-xl text-white font-bold justify-center underline underline-offset-8">{show.title}</h3>
                                        <p className="text-xs text-white text-gray-700 py-2">*Click title to see detail website</p>

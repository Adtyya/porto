        ...
        <>
            <div className="container mx-auto">
                <div className="flex justify-center flex-col items-center h-screen px-3">
                    ...
                    <p className="my-8">Below are some of my abilities, although I'm not too expert but I understand how to use this:</p>
                    <div className="py-3">    
                    <Marquee direction="right" speed={150}>
                        {skills.map((show)=>{
                        return(
                            <div>
                            <img src={show.image} className="h-10 md:h-14 px-5 py-2"/>
                            </div>
                        )
                        })}
                    </Marquee>
